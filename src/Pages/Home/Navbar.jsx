      ...
      <nav className="navbar">
        ...
        <div className="navbar-center">
          ...
          <div className="categories">
            <span onClick={() => scrollToSection("all-food")}>All</span>
            ...
            <span onClick={() => scrollToSection("veg-food")}>Vegetarian</span>
        ...
        <div className="navbar-icons">
          {/* Cart */}
          <Link to="/cart" state={{ cart }} className="nav-icon cart-icon">
            <ShoppingCartIcon />

            <p className="cart-count">
              {cart.reduce((total, food) => total + food.quantity, 0)}
            </p>
          </Link>
      ...
      {openMyOrder && (
        <div className="order-list">
          <div className="order-box" onClick={(e) => e.stopPropagation()}>
            ...
            <button onClick={() => setOpenMyOrder(false)}>Close</button>
          </div>
        </div>
      )}
    </>
